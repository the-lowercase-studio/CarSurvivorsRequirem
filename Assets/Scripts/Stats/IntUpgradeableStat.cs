...
namespace Assets.Scripts.Stats
{
    ...
    public class IntUpgradeableStat : UpgradeableStat<int>
    {
        ...
        public IntUpgradeableStat(int value, int maxValue, IntValueRange minMaxRange, IntValueRange rangeOfPossibleValuesForUpgrade, bool alwaysUseMinValueForUpgrade = false)
            : base(value, minMaxRange, rangeOfPossibleValuesForUpgrade, alwaysUseMinValueForUpgrade)
        {
        }

        public IntUpgradeableStat(int value, int maxValue, bool alwaysUseMinValueForUpgrade = false)
